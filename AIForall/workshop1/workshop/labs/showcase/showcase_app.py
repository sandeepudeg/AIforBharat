...
with col1:
    ...
    prompt_selection = st.selectbox("Select a prompt template:", prompts_keys,key="prompt_selectbox")
    
    with st.expander("View prompt"):

        selected_prompt_template_text = examples.prompts[prompt_selection]

        prompt_text = st.text_area("Prompt template text:", value=selected_prompt_template_text, height=350,key="prompt_text_area")
