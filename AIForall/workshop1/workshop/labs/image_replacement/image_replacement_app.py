...
with col2:
    mask_prompt = st.text_input("Object to remove/replace", value="peach curtains", help="The mask text")
    
    prompt_text = st.text_area("Object to add (leave blank to remove)", value="polka dot curtains", height=100, help="The prompt text")
