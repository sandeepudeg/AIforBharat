"""
Generate a visual demonstration of Kiro's spec-driven development workflow.
Creates an animated sequence showing how Kiro accelerated Snake Adaptive AI development.
"""
...
def create_demo_script():
    """Create a Python script that generates the demo frames"""
...
def create_frame_7():
    ...
    for task, desc, y in tasks:
        ...
        ax.text(9, y, "✓", fontsize=14, weight='bold', color=COLOR_SUCCESS)
...
create_frame_1()
print("✓ Frame 1: Traditional Development")
create_frame_2()
print("✓ Frame 2: Kiro Approach")
create_frame_3()
print("✓ Frame 3: Specs Structure")
create_frame_4()
print("✓ Frame 4: Requirements")
create_frame_5()
print("✓ Frame 5: Correctness Properties")
create_frame_6()
print("✓ Frame 6: Property-Based Testing")
create_frame_7()
print("✓ Frame 7: Task Management")
create_frame_8()
print("✓ Frame 8: Results")

print("\\nAll frames generated in kiro_demo_frames/")
print("Ready to convert to GIF or video!")
'''
    
    with open("create_demo_frames.py", "w") as f:
        f.write(demo_code)

def main():
    print("Creating Kiro development demo visualization...")
    print()
    
    # Create the frame generation script
    create_demo_script()
    
    # Run it
    print("Running frame generation...")
    result = subprocess.run(["python", "create_demo_frames.py"], capture_output=True, text=True)
    print(result.stdout)
    if result.stderr:
        print("Errors:", result.stderr)
    
    # Check if frames were created
    frames_dir = Path("kiro_demo_frames")
    if frames_dir.exists():
        ...
        try:
            ...
            imageio.mimsave("kiro_development_demo.gif", images, duration=2)
            print("✅ GIF created: kiro_development_demo.gif")
        except ImportError:
            print("\n⚠️  imageio not installed. To create GIF:")
            print("   pip install imageio")
            print("   python -c \"import imageio; images = [imageio.imread(f'kiro_demo_frames/frame_{i:02d}_*.png') for i in range(1,9)]; imageio.mimsave('kiro_development_demo.gif', images, duration=2)\"")
        
        # Instructions for video
        print("\n📹 To create MP4 video from frames:")
        print("   ffmpeg -framerate 0.5 -i kiro_demo_frames/frame_%02d_*.png -c:v libx264 -pix_fmt yuv420p kiro_development_demo.mp4")
        
    else:
        print("❌ Failed to create frames directory")
