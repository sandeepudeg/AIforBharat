...
class RetrieveAPI:
    ...
    def __init__(self, aws_config: AWSConfig):
        ...
        self.bedrock_client = aws_config.get_client("bedrock-agent-runtime")

    def retrieve(self,knowledge_base_id: str,query: str,config: Optional[RetrievalConfig] = None) -> List[RetrievalResult]:
        """
        ...
        try:
            ...
            response = self.bedrock_client.retrieve(
                ...
                retrievalConfiguration={
                    "vectorSearchConfiguration": {
                        ...
                        "overrideSearchType": config.retrieval_type.value.upper()
                    }
                },
                retrievalQuery={
                    "text": query
            ...
            for result in response.get("retrievalResults", []):
                ...
                # source_document = result.get("documentId", "")
                source_document = metadata.get("x-amz-bedrock-kb-source-uri", location)
