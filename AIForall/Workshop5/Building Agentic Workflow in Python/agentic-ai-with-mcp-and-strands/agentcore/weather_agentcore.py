...
# correct command  = curl -N -X POST http://localhost:8082/invocations ^
#   -H "Content-Type: application/json" ^
#   -d '{\"input\":\"What is the weather like in New York?\"}'

# or curl -N -X POST http://localhost:8082/invocations -H "Content-Type: application/json" -d "{\"input\":\"What is the weather like in New York?\"}"
