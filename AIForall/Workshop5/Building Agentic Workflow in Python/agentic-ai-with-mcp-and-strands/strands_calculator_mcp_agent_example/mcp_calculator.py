...
def start_calculator_server():
    ...
    def square_root(n: float) -> str:
        ...
        Returns:
            The square root as a string, or an error message if n is negative.
        """
        if n < 0:
            return "Error: Cannot calculate the square root of a negative number in this calculator."
        
        result = math.sqrt(n)
        return f"The square root of {n} is {result}"
