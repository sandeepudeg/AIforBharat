"""
Test Weather, Flight, Hotel, Itinerary, and Budget agents working together.
"""
...
def test_all_five_agents():
    """Test all five agents together."""
    ...
    print("=" * 70)
    print("Testing 5 Agents: Weather + Flight + Hotel + Itinerary + Budget")
    print("=" * 70)
    ...
    print(result)
    print("\n" + "=" * 70)
    print("Test Complete - All 5 Agents Working Together")
    print("=" * 70)


if __name__ == "__main__":
    test_all_five_agents()
