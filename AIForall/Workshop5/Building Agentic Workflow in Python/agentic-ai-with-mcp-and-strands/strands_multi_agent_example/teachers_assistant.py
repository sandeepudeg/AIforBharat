...
TEACHER_SYSTEM_PROMPT = """
You are TeachAssist, an orchestrator routing queries to subject specialists:
- Math Agent: Calculations and math concepts.
- English Agent: Writing and literature.
- Language Agent: Translation.
- Computer Science Agent: Programming and CS theory.
...
if __name__ == "__main__":
    print("\n📁 Teacher's Assistant (Windows Version) 📁\n")
    while True:
        try:
            user_input = input("\n> ")
